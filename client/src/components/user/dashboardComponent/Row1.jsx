            ...
            <Stack direction={"row"} justifyContent={"space-between"}>
              ...
              <Stack>
                <Box height={"80px"} width={"150px"}>
                  <Chart
                    fakeData={[{ id: "users", value: data.numberOfUsers }]}
                    scheme={"blue"}
                  />
                </Box>
              </Stack>
            ...
            <Stack direction={"row"} justifyContent={"space-between"}>
              ...
              <Stack>
                <Box height={"80px"} width={"150px"}>
                  <Chart
                    fakeData={[
                      { id: "products", value: data.numberOfProducts },
                    ]}
                    scheme={"blue"}
                  />
                </Box>
            ...
            <Stack direction={"row"} justifyContent={"space-between"}>
              ...
              <Stack>
                <Box height={"80px"} width={"150px"}>
                  <Chart
                    fakeData={[
                      { id: "customers", value: data.numberOfcustomers },
                    ]}
                    scheme={"blue"}
                  />
                </Box>
          ...
          <Paper sx={{ bgcolor: "#007FFF", p: 1.5 }} elevation={6}>
            <Stack direction={"row"} justifyContent={"space-between"}>
              ...
              <Stack>
                <Box height={"80px"} width={"150px"}>
                  <Chart
                    fakeData={[{ id: "orders", value: data.numberOforders }]}
                    scheme={"nivo"}
                  />
                </Box>
              </Stack>
